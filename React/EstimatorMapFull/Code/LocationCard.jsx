...
const WalkingInfo = ({
  ...
  <li className="location-list-item" onClick={walkingClickhandler}>
    <div className="location-icon-group">
      <em className="fa-2x mr-2 fas fa-walking"></em>
    </div>
    <div className="location-option-content">
        ...
        <div className="location-card-list-container">
          <ul>
            ...
            <li className="location-list-item">
              ...
              <div className="location-option-content">
                <div className="deliverytype-title">AirPals</div>

                <div className="delivery-option">
                  In 7 mins. 09:05am dropoff.
                </div>
              </div>
              <div className="delivery-price-container">
                <span className="delivery-price">$30-35</span>
              </div>
            </li>

            <li className="location-list-item">
              <div className="location-icon-group">
                <em className="fa-2x mr-2 fas fa-truck"></em>
              </div>
              <div className="location-option-content">
                <div className="deliverytype-title">AirPals PLUS</div>
              ...
              <div className="delivery-price-container">
                <span className="delivery-price">$36-45</span>
              </div>
            </li>
          </ul>
        </div>
    ...
    <div className="location-card-container">
      <div className="location-data-container">
        <div className="location-card-header">
          <div className={`location-origin-address`}>
          ...
          <div className={`location-destination-address`}>
        ...
        <div className="sign-up-btn-container">
          <button onClick={handleRedirect} className="sign-up-btn">
            Sign up now
            <img src="airpals_logo_32x32.png" alt="Logo" />
          </button>
        </div>
      </div>
    </div>
